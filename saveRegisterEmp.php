...
<?php
    ...
    {   
        ...
        $strSQL = "INSERT INTO user (name,employee_id,department,telno,phone,email,status,username,password) 
                        VALUES ('".$_POST["fullname"]."','".$_POST["employeecode"]."','".$_POST["department"]."','".$_POST["telephone"]."','".$_POST["phone"]."','".$_POST["email"]."','".$_POST["status"]."','".$_POST["username"]."','".$_POST["password"]."')";
        $objQuery = mysqli_query($Connection,$strSQL);


        $strSQL = "INSERT INTO employee (empID,empName,empPosition) 
                        VALUES ('".$_POST["employeecode"]."','".$_POST["fullname"]."','".$_POST["Position"]."')";
        $objQuery = mysqli_query($Connection,$strSQL);
